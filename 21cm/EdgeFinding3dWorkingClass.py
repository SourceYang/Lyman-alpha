...
def frontTriangle(x1,y1,z1,x2,y2,z2,x3,y3,z3):
   # triangle0 = triangle(x1,y1,z1,x2,y2,z2,x3,y3,z3)
    center0 = triangle.center(x1,y1,z1,x2,y2,z2,x3,y3,z3)
    area0 = triangle.area(x1,y1,z1,x2,y2,z2,x3,y3,z3)
    #print(area0)
    nhat0 = triangle.nhat(area0,x1,y1,z1,x2,y2,z2,x3,y3,z3)
    triangle1= triangles(area0,center0,(x1,y1,z1),(x2,y2,z2),(x3,y3,z3),nhat0)
    return triangle1
